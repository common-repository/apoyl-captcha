...
class apoyl_captcha_clicaptcha{
		...
		public function creat(){
			$imagePathArr = array(APOYL_CAPTCHA_DIR.'api/clicaptcha/image/1.jpg', APOYL_CAPTCHA_DIR.'api/clicaptcha/image/2.jpg', APOYL_CAPTCHA_DIR.'api/clicaptcha/image/3.jpg');
			$imagePath = $imagePathArr[rand(0, count($imagePathArr) - 1)];
	
			$fontPath = realpath(APOYL_CAPTCHA_DIR.'api/clicaptcha/font/SourceHanSansCN-Normal.ttf');
		...
		public function check($info, $unset = true){
			...
			if(isset($_SESSION['clicaptcha_text'])){
				$textArr = sanitize_text_field($_SESSION['clicaptcha_text']);
